...
public class SchedulerProcessStage extends RealtimeOperationModel {

    public SchedulerProcessStage() {
        super(Type.Scheduler, Type.ProcessStage);
    }

    public void loadRules() {
        super.loadRules();
        addLinkingRule(new UniqueParentLinking(Type.GraphX, Type.ProcessGraph));
