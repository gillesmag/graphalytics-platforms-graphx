...
//                    add("ArchivingTime");
    ...
    protected class ProcessingTimeDerivation extends DerivationRule {
        ...
        public boolean execute() {
            Operation operation = (Operation) entity;
            Operation processGraph = operation.findSuboperation(GraphXType.SparkJob).findSuboperation(GraphXType.ProcessGraph);
    ...
    protected class SummaryDerivation extends BasicSummaryDerivation {
        ...
        public boolean execute() {
                Operation operation = (Operation) entity;
                String summary = String.format("The [%s] operation is the top-level operation of each GraphX job. ", operation.getName());
